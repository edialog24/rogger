...
class Main {
    ...
    getLoggerConfig(amqpoptions){
     //   console.log("configuring logger"+ this.clevel);
        return {
            transports: [
    ...
    send(sendObj) {
        if(!sendObj.meta) {
            ...
            this.logger(sendObj.level, sendObj.msg,sendObj.meta);
        }
        else {
            this.logger(sendObj.level, sendObj.msg,sendObj.meta,sendObj.cb);
        }
    }
